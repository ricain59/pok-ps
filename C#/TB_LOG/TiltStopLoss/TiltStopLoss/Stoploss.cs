        ...
        private void calculateBB()
        {
            ...
            if (tracker == 1 || tracker == 2)
            {
                ...
                else
                {
                    ...
                    new Debug().LogAlert(bbinit.ToString(), "bbini au debut");
            ...
            else //pt4
            {
                ...
                new Debug().LogAlert(lastidsessionpt4.ToString(), "PT4 récupère le dernier id");
            }
                ...
                try
                {
                    ...
                    if (tracker == 1 || tracker == 2)
                    {
                        ...
                        else
                        {
                            ...
                            new Debug().LogAlert(bb.ToString(), "bb au debut du calcul");
                        }
                    }
                    else //pt4
                    {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < playeridname.Count; i++)
                        {
                            ...
                            new Debug().LogAlert(handnumber.ToString(), "PT4 pendant le cycle");
                        }
                        new Debug().LogAlert(handnumber.ToString(), "PT4 a la fin du cycle");
                    }
                    if (this.labelBb.InvokeRequired)
                    {
