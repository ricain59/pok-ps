...
namespace XSystem.WinControls
{
    ...
    public class RatingBar : Control
    {
        ...
        void UpdateIcons()
        {
            ...
            {
                iconEmpty = StopLoss.Properties.Resources.iconStarEmpty;
                iconFull = StopLoss.Properties.Resources.iconStarFull;
                iconHalf = StopLoss.Properties.Resources.iconStartHalf;
            }
            else if (iconStyle == IconStyle.Heart)
            {
                iconEmpty = StopLoss.Properties.Resources.iconHeartEmpty;
                iconFull = StopLoss.Properties.Resources.iconHeartFull;
                iconHalf = StopLoss.Properties.Resources.iconHeartHalf;
            }
            else if (iconStyle == IconStyle.Misc)
            {
                iconEmpty = StopLoss.Properties.Resources.iconMiscEmpty;
                iconFull = StopLoss.Properties.Resources.iconMiscFull;
                iconHalf = StopLoss.Properties.Resources.iconMiscHalf;
            }
        }
        #endregion
